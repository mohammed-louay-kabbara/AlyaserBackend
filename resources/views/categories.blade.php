                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-md-6 col-lg-8 text-end">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                data-bs-target="#exampleModalcreatecategory"> إضافة صنف جديد
                                            </button>
                                        </div>
                                    </div>
                                    <div class="modal fade" id="exampleModalcreatecategory" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">إضافة صنف جديد
                                                    </h5>
                                                ...
                                                <tbody>
                                                    @foreach ($categories as $u)
                                                        <tr>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">تعديل الصنف
                                                                                </h5>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form
                                                                                    action="{{ route('Category.update', $u->id) }}"
                                                                                    method="post">
                                                                                    @method('PUT')
                                                                                    @csrf
                                                                                    <input type="text"
                                                            ...
                                                            <td class="align-middle text-center text-sm">
                                                                <form action="{{ route('Category.destroy', $u->id) }}"
                                                                    method="post"
