        ...
        <div class="container-fluid py-4">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        ...
                                        <p class="mb-0">
                                            عدد الطلبات التي قام المستودع بتجهيزها
                                        </p>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                            ...
                                            <div class="carousel-item h-100 {{ $index == 0 ? 'active' : '' }}"
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <i
                                                            class="ni {{ $index == 0 ? 'ni-camera-compact' : 'ni-bulb-61' }} text-dark opacity-10"></i>
                                                    </div>
                                                    <h5 class="text-white mb-1">
                                                        {{ $index == 0 ? 'العرض الأول' : 'عرض مميز' }}</h5>
                                                    <p class="text-white">{{ $of->description }}</p>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                @else
                                    <div class="p-4 text-center">لا توجد عروض حالية</div>
                                @endif
                            </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-7 mb-lg-0 mb-4">
                    <div class="card ">
                        <div class="card-header pb-0 p-3">
                            <div class="d-flex ">
                                <h6 class="mb-2">سعر الصرف لآخر ثلاثة أيام</h6>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table align-items-center ">
                                <tbody>
                                    @foreach ($exchange_rates as $ex)
                                        <tr>
                                            <td class="w-30">
                                                <div class="d-flex px-2 py-1 align-items-center">
                                                    <div class="ms-4">
                                                        <p class="text-xs font-weight-bold mb-0">اسم العملة:</p>
                                                        <h6 class="text-sm mb-0">{{ $ex->currency_name }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">سعر الصرف:</p>
                                                    <h6 class="text-sm mb-0">{{ $ex->rate }}</h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="text-center">
                                                    <p class="text-xs font-weight-bold mb-0">تاريخ:</p>
                                                    <h6 class="text-sm mb-0">{{ $ex->created_at }}</h6>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-header pb-0 p-3">
                            <h6 class="mb-0">المنتجات الأكثر طلباً</h6>
                        </div>
                        <div class="card-body p-3">
                            <ul class="list-group">
